...
public class ValueModule<T> : Module, IModifiableValue<T>
{
    ...
    public ValueModule(string moduleName, T baseValue) : base(moduleName)
    {
        _value = baseValue;
        _modifiers = new(this);
    ...
    public override string ToString() {
        return string.Format("{0} ({1})", BaseValue, ModifiedValue);
    }
}